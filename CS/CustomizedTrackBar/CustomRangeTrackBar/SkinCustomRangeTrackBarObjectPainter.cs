...
{
    class SkinCustomRangeTrackBarObjectPainter : SkinRangeTrackBarObjectPainter
    {
        public SkinCustomRangeTrackBarObjectPainter(ISkinProvider provider) : base(provider) { }
